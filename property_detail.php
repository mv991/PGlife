...
$property_id = $_GET["property_id"];  //we are basically sending a prop called property_id with value assigned as id from properties table
...
//getting the city name to display it in the breadcrumb
$city_id = $property['city_id'];
$sql_1 = "select name from cities where id = $city_id";
...
//using sql join query to join amenities and amenities_properties to get the amenity images
$sql_3 = "select a.* 
          from ameneties as a 
          inner join properties_ameneties as pa 
...
$ameneties = mysqli_fetch_all($result_3,MYSQLI_ASSOC);       
if(!$ameneties){
    echo "something went wrong";
    return;
}   
...
<?php include "includes/header.php";?>
    ...
    <div class="property-summary page-container">
        <div class="row no-gutters justify-content-between">
            ...
            <?php $total_rating =  ($property['rating_clean'] + $property['rating_food'] + $property['rating_safety'])/3;
        ...
        <div class="page-container">
            ...
            <div class="row justify-content-between">
                <div class="col-md-auto">
                    <h5>Building</h5>
                    <?php foreach($ameneties as $amenity)  
                    {
    ...
    <div class="property-testimonials page-container">
        ...
        <div class="testimonial-block">
            ...
            <div class="testimonial-name">- <?=$testimony['user_name']?></div>
        </div>
